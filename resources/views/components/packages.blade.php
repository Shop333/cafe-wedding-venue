    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="bg-stone-50 rounded-[2.5rem] p-8 border border-stone-100 flex flex-col hover:shadow-2xl transition-all duration-500 group">
                ...
                <div class="mb-6">
                    <h4 class="text-2xl font-serif text-stone-900 mb-2">{{ $package->name }}</h4>
                    <p class="text-stone-500 text-sm font-light leading-relaxed h-12 overflow-hidden">{{ $package->description }}</p>
                </div>
                ...
                <div class="mb-6 py-6 border-y border-stone-200/60">
                    ...
                    <span class="text-3xl font-serif text-stone-900">{{ $package->formatted_price }}</span>
                    <div class="mt-2 flex items-center gap-2 text-stone-500 text-xs">
                        ...
                        <span>Kapasitas: {{ $package->capacity }}</span>
                    </div>
                </div>
